  ...
  return (
    <section className="relative z-20 -mt-24 px-4">
      <div className="max-w-6xl mx-auto">
        <FadeIn>
          <div className="bg-[#1A3A5C] rounded-2xl px-8 md:px-16 py-12 md:py-16 text-center text-white shadow-xl transition-shadow duration-300 hover:shadow-2xl">
            ...
            <p className="text-xs tracking-[0.6em] mt-2 opacity-70">SOLUTION</p>
