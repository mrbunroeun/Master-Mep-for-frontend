  ...
  return (
    <MepLayout>
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, #0C1F3F 0%, #1E5BA8 100%)" }}
      >
        <FadeIn className="relative z-10 max-w-2xl mx-auto px-6">
          ...
          <Link
            href="/contact"
            className="inline-block px-8 py-3 bg-[#2E5C8A] rounded-xl hover:bg-white hover:text-[#1A3A5C] transition-colors font-medium text-sm"
          >
            Contact Us
          </Link>
        </FadeIn>
