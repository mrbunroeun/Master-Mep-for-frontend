...
export default function Create() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("admin.activity.store"), { forceFormData: true });
    };
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="p-6 max-w-2xl">
                <h1 className="text-2xl font-bold text-[#1A3A5C] mb-6">New Activity</h1>
                ...
                <form onSubmit={submit} className="space-y-5 bg-white p-6 rounded-xl shadow-sm">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. Project Update, Company News, Training"
                            className="w-full border rounded-lg p-2"
                        />
